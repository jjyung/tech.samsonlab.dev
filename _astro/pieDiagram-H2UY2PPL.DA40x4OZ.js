import{r as e}from"./chunk-PTVI3W5X.DVfdoxm6.js";import{M as t,N as n,T as r,n as i}from"./chunk-X5WJYYCX.DjkliBG3.js";import{C as a,E as o,J as s,Q as c,Y as l,b as u,l as d,m as f,o as p,x as m}from"./chunk-AHS5MEEA.8CJKbDJv.js";import{t as h}from"./chunk-6ZKBGPIT.DkAjt7_Q.js";import{M as g}from"./chunk-Z2I5LGMO.DtD3gp8b.js";import"./chunk-IPM4HZQ6.BTP20CLA.js";import{h as _,i as v}from"./chunk-TYR5776D.DpKzElEW.js";import{f as y}from"./mermaid.esm.CIOIjITP.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,p()},`clear`),setDiagramTitle:c,getDiagramTitle:o,setAccTitle:l,getAccTitle:m,setAccDescription:s,getAccDescription:u,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),r.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{h(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let t=await g(`pie`,e);r.debug(t),E(t,T)},`parse`)},O=e(e=>`
  .pieCircle{
